...
+==============================================================================+
+------------------------------------------------------------------------------+
| SnakeByte: An cracker game for entertainment.                                |
|                                                                              |                                                              
| Writing by: Eddie Brüggemann                                                 |
| Writing programming language: python 2.7.3                                   |
...
| from this level. You can choice the level by clicking on the arrows Next or  |
| Prev or by hitting the left and right arrows.                                |
|                                                                              |
...
| -The 'z' key to stop the snake going forward, by rehitting 'z' the snake     |
|  move forward again.                                                         |
|                                                                              |
...
| -The 'd' key to slide to your right.                                         |
| -The 'w' key to stop the snake going forward, by rehitting 'w' the snake     |
|  move forward again.                                                         |
|                                                                              |
| At the end of an level the game will ask you if you want to register your    |
| score: the number of eated apples.                                           |
| Per defult No is selected but you can switch with the right and left arrows. |
...
| # . install.sh                                                               |
|                                                                              |
| SnakeByte is now correctly installed and you can remove the extracted        |
| folder.                                                                      |
|                                                                              |
| If you want to remove SnakeByte from your system.                            |
| Run the desintallation script: unsinstall.sh                                 |
|                                                                              |
| $ su root                                                                    |
| password:                                                                    |
| $ . unsinstall.sh                                                            |
